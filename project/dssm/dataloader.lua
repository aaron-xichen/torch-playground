...
function DataLoader.create(opt)
    local loaders = {}
    loaders[1] = M.DataLoader(opt.trainQueryFilePath, opt.trainDocFilePath, opt.batchSize, opt.trainNSamples, opt.nFeature)
    loaders[2] = M.DataLoader(opt.testQueryFilePath, opt.testDocFilePath, opt.batchSize, opt.testNSamples, opt.nFeature)
